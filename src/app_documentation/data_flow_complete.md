...
**File**: `src/lib/logic/knowledge-service.ts` + `src/app/actions/generate-outfit.ts`
...
**File**: `src/app/actions/generate-outfit.ts`
...
**File**: `src/actions/generate-look.ts`
...
**File**: `src/views/outfit/TodayOutfitView.tsx`
...
3. **Local Logic**:
   ...
   - `filterByLayeringRules` (sleeve/color filtering)
