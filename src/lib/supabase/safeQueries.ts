...
export type SafeQueriesApi = {
	...
	getGarments: (userId: string, filters?: { category?: string; color?: string; season?: string; brand?: string }) => Promise<Garment[]>;
	createGarment: (userId: string, garment: Omit<Garment, "id" | "user_id" | "created_at" | "updated_at" | "wear_count">) => Promise<Garment | null>;
	updateGarment: (garmentId: string, updates: Partial<Omit<Garment, "id" | "user_id" | "created_at" | "updated_at">>) => Promise<Garment | null>;
